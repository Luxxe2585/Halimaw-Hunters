...
enum CharacterType {ALL, BROTHERS, KUDAMAN, DATUPUTI, WARRIOR} 
#remove warrior later
...
# This method should be implemented by event-based/consumable
# relics which connect to the EventBus to make sure that they
# are disconnected when a relic gets removed.
