...
# meta-description: An action that can be performed by an eenemy during its turn.
extends  EnemyAction
...
# ex. for attack actions, the Player's DMG TAKEN modifier will affect the resulting damage number
